// Footer component that will be displayed in every page with credits, <a> tags do not take anywhere
    ...
    <div>
      <footer className='footer mt-auto py-5'>
        ...
        <div id='credits' className='d-flex justify-content-center pb-0 mt-5'>
          ...
          Icons made by
          <a href='https://www.flaticon.com/authors/pixel-buddha' title='Pixel Buddha' className='mr-2'>
            Pixel Buddha
          </a>
          from
          ...
          Icons made by{" "}
          <a href='https://www.flaticon.com/authors/pixel-perfect' title='Pixel perfect' className='mr-2'>
            Pixel perfect
          </a>{" "}
          from{" "}
          <a href='https://www.flaticon.com/' title='Flaticon' className='mr-2'>
